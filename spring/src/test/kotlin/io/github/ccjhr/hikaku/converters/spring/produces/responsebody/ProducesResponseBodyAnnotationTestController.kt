...
open class RequestMappingOneMediaTypeIsInheritedByAllFunctionsController {
    ...
    @RequestMapping("/{id}")
    fun getSpecificTodo() = ResponseEntity.status(200).body(
        RequestMappingOneMediaTypeIsInheritedByAllFunctionsController()
    )
}
...
open class RequestMappingMultipleMediaTypesAreInheritedByAllFunctionsController {
    ...
    @RequestMapping
    fun getAllTodos() = ResponseEntity.status(200).body(
        RequestMappingMultipleMediaTypesAreInheritedByAllFunctionsController()
    )
...
open class RequestMappingOneMediaTypeIsOverwrittenByDeclarationOnFunctionController {
    ...
    fun getAllTodos() = ResponseEntity.status(200).body(
        RequestMappingOneMediaTypeIsOverwrittenByDeclarationOnFunctionController()
    )
...
open class RequestMappingMultipleMediaTypesAreOverwrittenByDeclarationOnFunctionController {
    ...
    fun getAllTodos() = ResponseEntity.status(200).body(
        RequestMappingMultipleMediaTypesAreOverwrittenByDeclarationOnFunctionController()
    )
